...
class ReadConfig:
  ...
  Attributes:
    ...
    disable_ordering_guard: When set to true it will not throw an exception when
      shuffling or interleaving an ordered dataset.
  """
  ...
  disable_ordering_guard: bool = False
